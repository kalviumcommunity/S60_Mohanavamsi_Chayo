...
function Home() {
    ...
    useEffect(() => {
        axios.get("https://qwty3g6kfx.ap-south-1.awsapprunner.com/users",{headers:{"authorization":getCookie("token")}})
            .then((res) => {
                setUsers(res.data);
            })
            .catch((error) => {
        ...
        axios.get("https://qwty3g6kfx.ap-south-1.awsapprunner.com/rooms",{headers:{"authorization":getCookie("token")}})
        .then((res)=>{
    ...
    function join(){
        if (room.trim() != "" && getCookie("username") ) {
            axios.get(`https://qwty3g6kfx.ap-south-1.awsapprunner.com/data/${room}`,{headers:{"authorization":getCookie("token")}}).then((res)=>{
