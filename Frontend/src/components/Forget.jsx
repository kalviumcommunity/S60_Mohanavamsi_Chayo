...
function Forget(){
    ...
    function otp() {
      ...
      setload(true)
      axios.post("https://qwty3g6kfx.ap-south-1.awsapprunner.com/otp",state).then(
          (res)=>{
  ...
  function reset() {
    ...
    setload(true)
      axios.put("https://qwty3g6kfx.ap-south-1.awsapprunner.com/otpvalid",{...state,otp:sessionStorage.getItem("otp"),userotp:state.otp}).then(
          (res)=>{
